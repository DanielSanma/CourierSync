...
public class ShipmentService {
    ...
    public ShipmentDTO updateStatus(Long id, ShipmentStatus status, String observations) {
        ...
        if (observations != null && !observations.trim().isEmpty()) {
            ...
            // Nota: Aquí podrías querer guardar 'history' en su propio repositorio si existe.
            // Actualmente, solo se crea el objeto 'history' sin guardarse ni vincularse al envío.
        }

        // Asumiendo que ShipmentMapper.INSTANCE es una forma estática de obtener el mapper (MapStruct/similar)
